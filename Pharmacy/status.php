	...
	<main>
			...
			<div class="table">
				...
				<?php if ($ile>=1)
				{
					...
					<h3> $imie oto Twoje niezrealizowane recepty:</h3>
					<tr>
...
END;
				...
				if ($ile==0) 
				{
						?><p><?php echo "<p> $imie brak niezrealizowanych recept";
				} ?>
			</div>
